...
public class MobilCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobil_customer);
        ...
        rvAset.setLayoutManager(new LinearLayoutManager(MobilCustomerActivity.this, LinearLayoutManager.VERTICAL,false));
    ...
    private void getAllMobil() {
        ...
        StringRequest stringRequest = new StringRequest(GET, RentalApi.TAMPILMOBILCUSTOMER, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Gson gson = new Gson();
                AsetResponse asetResponse = gson.fromJson(response,AsetResponse.class);
                adapter.setMobilList(asetResponse.getAsetList());
                rvAset.setAdapter(adapter);
                Toast.makeText(MobilCustomerActivity.this, asetResponse.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                try{
                    ...
                    Toast.makeText(MobilCustomerActivity.this,
                            errors.getString("message"), Toast.LENGTH_SHORT).show();
                }catch (Exception e){
                    Toast.makeText(MobilCustomerActivity.this, e.getMessage(),
