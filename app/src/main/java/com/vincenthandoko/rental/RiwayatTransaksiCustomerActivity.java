...
public class RiwayatTransaksiCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvRiwayatCustomer.setLayoutManager(new LinearLayoutManager(RiwayatTransaksiCustomerActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    private void getAllRiwayat() {
        ...
        StringRequest stringRequest = new StringRequest(GET, RentalApi.TAMPILRIWAYATCUSTOMER+id, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(RiwayatTransaksiCustomerActivity.this, riwayatTransaksiResponse.getMessage(), Toast.LENGTH_SHORT).show();
                rvRiwayatCustomer.setAdapter(adapter);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                try{
                    ...
                    Toast.makeText(RiwayatTransaksiCustomerActivity.this,
                            errors.getString("message"), Toast.LENGTH_SHORT).show();
                }catch (Exception e){
                    Toast.makeText(RiwayatTransaksiCustomerActivity.this, e.getMessage(),
